<div class="rel"><h2> Related For <?php the_title(); ?> </h2>
...
<h3><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><?php the_title(); ?></a></h3> </div>
...
$post = $orig_post;
wp_reset_query(); ?><div style="clear: both"></div></div>